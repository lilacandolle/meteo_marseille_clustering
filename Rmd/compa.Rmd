...
if (mac) {
  # Mac
  df_mf <- read.csv("/Volumes/T7_Shield/_stageCO2/data/Meteo_France/LCPMARVAL_20162025.csv", header = TRUE, sep = ",")
  setwd("/Volumes/T7_Shield/_stageCO2/codeLila/ERA5vsOBS")
  figpath = ("/Volumes/T7_Shield/_stageCO2/figures_compa/")
  nc_windu_era5 <- nc_open("/Volumes/T7_Shield/_stageCO2/data/ECMWF/forcomparison/20222023_MARcoords_ERA5windu.nc")
  nc_windv_era5 <- nc_open("/Volumes/T7_Shield/_stageCO2/data/ECMWF/forcomparison/20222023_MARcoords_ERA5windv.nc")
  nc_t2m_era5 <- nc_open("/Volumes/T7_Shield/_stageCO2/data/ECMWF/forcomparison/20222023_MARcoords_ERA5_t2m.nc")
  nc_tp_era5 <- nc_open("/Volumes/T7_Shield/_stageCO2/data/ECMWF/forcomparison/20222023_MARcoords_ERA5_totalprecipitation.nc")
  } else {
  # Windows
  df_mf <- read.csv("E:\\_stageCO2\\data\\Meteo_France\\LCPMARVAL_20162025.csv", header = TRUE, sep = ",")
  setwd("E:\\_stageCO2\\codeLila\\ERA5vsOBS")
  figpath <- "E:\\_stageCO2\\fig_meteofrance\\"
  nc_windu_era5 <- nc_open("E:\\_stageCO2\\data\\ECMWF\\forcomparison\\20222023_MARcoords_ERA5windu.nc")
  nc_windv_era5 <- nc_open("E:\\_stageCO2\\data\\ECMWF\\forcomparison\\20222023_MARcoords_ERA5windv.nc")
  nc_t2m_era5 <- nc_open("E:\\_stageCO2\\data\\ECMWF\\forcomparison\\20222023_MARcoords_ERA5_t2m.nc")
  nc_tp_era5 <- nc_open("E:\\_stageCO2\\data\\ECMWF\\forcomparison\\20222023_MARcoords_ERA5_totalprecipitation.nc")
  }
```
...
a <- ggplot(df_3j, aes(x = heures, y = 0)) +
  geom_point() +
  geom_segment(aes(xend = heures + windu_mf, yend = windv_mf), y = 0,
               arrow = arrow()) +
  scale_x_continuous(
    name = NULL,
    breaks = pretty(df_3j$heures, n = 7),
    labels = NULL
  ) +
  coord_fixed() +
  theme_minimal() +
...
b <- ggplot(df_3j, aes(x = heures, y = 0)) +
  geom_point() +
  geom_segment(aes(xend = heures + windu_era5, yend = windv_era5), y = 0,
               arrow = arrow()) +
  scale_x_continuous(
    name = NULL,
    breaks = pretty(df_3j$heures, n = 7),
